    ...
    <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
      ...
      <button
        ...
        style={{
          ...
          color: step.privateAccess === 'private' ? '#ef4444' : '#a3a3a3',
          border: `1px solid ${step.privateAccess === 'private' ? '#ef4444' : '#a3a3a3'}`,
          borderRadius: 3,
          fontWeight: 'bold',
          fontSize: 9,
          cursor: 'pointer',
      ...
      <button 
        ...
        style={{
          ...
          color: isVisionGenerating ? '#666' : '#a3a3a3',
          border: `1px solid ${isVisionGenerating ? '#444' : '#a3a3a3'}`,
          borderRadius: 3,
          fontWeight: 'bold',
          fontSize: 9,
