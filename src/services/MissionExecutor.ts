...
import { useCreditStore, consumeCreditsServer, refundCreditsServer } from '../stores/creditStore';
...
export class MissionExecutor {
  ...
  async execute(
    ...
    try {
      ...
      if (creditsConsumed && creditsRequired > 0) {
        refundCreditsServer(
          creditsRequired,
